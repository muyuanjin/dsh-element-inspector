...
dsh-element-inspector runs locally. It reads runtime source files only from packages declared in the active DSH profile, opens verified installed-package paths with the operating system's file manager, and stores preferences through the official DSH settings service. It does not upload inspected element data, screenshots, HTML, or Markdown.
